...
import monts from '../../utils/fontFile';
...
const AddCity = ({ visible, setVisible, credit, llc, state, enityName, llcDetails,modelData }) => {
    ...
    useEffect(() => {
        ...
        if (credit !== null && credit !== undefined) {
            Object.keys(credit).map((key, i) => {
                setValue(key, credit[key])
            })

        }

        if (llc !== null && llc !== undefined) {
            Object.keys(llc).map((key, i) => {

                setValue(key, llc[key])
            })

        }

        if (llcDetails !== null && llcDetails !== undefined) {
            Object.keys(llcDetails).map((key, i) => {

                setValue(key, llcDetails[key])
            })
    ...
    }, [setValue, creditInfo, credit, llc, llcDetails])
            ...
            case 'string':
                return <>
                    <div className=" justify-content-center dialog-form-field-space ml-2">
                        <div className="field">
                            <div className='d-flex download-form-field'>
                                <label htmlFor='' className=' font-fam-for-all' style={{ fontWeight: 'bold', fontSize: '14px' }}>{convertToTitleCase(key)} </label>
    ...
    return (
        <div>
            <Dialog header={handleHeader} visible={visible} className='dialog-box' modal={false} onHide={dialogView}  >
                <form id='myform' className='form-spacing' onSubmit={onSubmit}>

                    <Toast ref={toast} />

                    <div ref={pdfRef} className='font-fam-for-all' style={{ width: '750px', padding: '10px', backgroundColor: 'white', margin: 'auto', fontSize: '14px' }}>


                        <div>
                            <img src={Logo} alt="logo" width={220} height={60}/>
                        </div>
                        <div className='d-flex justify-content-center mb-5' style={{ fontSize: '18px', fontWeight: 'bold' }}>
                            LLC Formation
                        </div>
                        <div className='grid pl-0 ml-2'>

                            <div className='col-6 pl-0'>
                                <p style={{ fontWeight: 'bold' }}>State Of Formation : <span style={{ color: 'red', fontWeight: 'bold' }}>{state}</span></p>
                            </div>
                            <div className='col-6'>
                                ...
                                <div className='grid'>
                                    ...
                                    <div className='col-8'>
                                        <Checkbox className='mb-1' checked={isChecked || enityName === "LLC"} onChange={(e) => onCheckboxChange(e)}></Checkbox>
                                        <span className='ml-1'>LLC</span>

                                        <Checkbox className='mb-1 ml-2' checked={isChecked1 || enityName === "PLCC"} onChange={(e) => onCheckboxChange1(e)}></Checkbox>
                        ...
                        <div className='col-12 ml-2' style={{marginTop:'230px'}}>
                        ...
                        <div className='ml-2'>
                            ...
                            <div className='grid pl-2' style={{ fontWeight: 'bold' }}>
                            ...
                            <div className='d-flex justify-content-center' style={{ marginTop: '100px', marginBottom: '250px' }}>
