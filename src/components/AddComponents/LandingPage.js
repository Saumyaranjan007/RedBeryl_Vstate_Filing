...
const LandingPage = () => {
                    ...
                    <div className='input-fields-container'>
                        <div className='input-fields-main'>
                            <div className=" justify-content-center dialog-form-field-space ">
                                <div className="field">
                                    <label htmlFor='' className='form-label font-fam-for-all'>{convertToTitleCase(key)} <span className='form-field-mandatory'>*</span></label>
    ...
    const onSubmit = (data) => {
        ...
        CreditCardServices.createCreditCardInfo(creditInfo)
            .then((res) => {
                console.log(res)
            })
            .catch((err) => {
        ...
        CreditCardServices.createLLCMembers(llc)
            .then((res) => {
                console.log(res)
            })
            .catch((err) => {
        ...
        CreditCardServices.createLLC(llcName)
            .then((res) => {
                console.log(res)
            })
            .catch((err) => {
    ...
    return (
        <div className='grid font-fam-for-all'>
                            ...
                            <div className='wizard-content-main'>
                                <div className='wizard-content-frame'>
                                    <div className='wizard-content-card'>
                                        ...
                                        <div style={{ marginTop: '40px', textAlign: 'center', marginBottom: '10px' }}>
                                                ...
                                                <form className='form-wizard' onSubmit={handleSubmit(onSubmit)}>
                                                    ...
                                                    <div className="tab">
                                                        ...
                                                        <div className='input-fields-container'>
                                                            ...
                                                            <div className='input-fields-main'>
                                                                <div className=" justify-content-center dialog-form-field-space ">
                                                                    <div className="field">
                                                                        <label htmlFor='' className='form-label font-fam-for-all'>DBA if applicable <span className='form-field-mandatory'>*</span></label>
                                                                        <span className="p-float-label ">
                                                                        ...
                                                                        <>
                                                                            ...
                                                                            {/* {middleIndex === i ?
                                                                                <div className='col-12'>
                                                                                    <div className='wizard-form-sub-header'>
                                                                                        <div className='wizard-form-sub-header-main'>
                                                                                            <div className='wizard-form-sub-header-text'>
                                                                                                LLC contact details
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                    ...
                                                    <div class="tab">
                                                        ...
                                                        <div className='wizard-content-sub-card-header mb-3' id="header">
                                                            <div className='wizard-content-sub-card-text-frame'>
                                                                <div className='wizard-content-sub-card-text'>
                                                                    Please provide management and organizer details for filling                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className='wizard-form-header' style={{ fontWeight: 'bold' }}>
                                                            Managed By
                                                            ...
                                                            <div className='entity-radio-content'>
                                                                <RadioButton inputId="ingredient1" name="pizza" value="LLC" onChange={(e) => setEntityName(e.value)} checked={enityName === 'LLC'} />
                                                                <label htmlFor="ingredient1" className="ml-2 mb-0">Member</label>
                                                            </div>
                                                            <div className='entity-radio-content'>
                                                                <RadioButton inputId="ingredient2" name="pizza" value="PLLC" onChange={(e) => setEntityName(e.value)} checked={enityName === 'PLLC'} />
                                                                <label htmlFor="ingredient2" className="ml-2 mb-0">Manager</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className='grid'>
                                                            {
                                                                initData1 !== null ? Object.keys(initData1).map((val, i) => {
                                                                    const keys = Object.keys(initData1);
                                                                    const middleIndex = Math.floor(keys.length / 2);
                                                                    return (
                                                                        <>
                                                    ...
                                                    <div class="tab">
                                                        ...
                                                        <Dropdown
                                                            value={llc}
                                                            options={llcMember}
                                                            onChange={handleLLCMember}
                                                            style={{ width: '100%', height: '47px' }}
                                                            placeholder="Select LLC Member"
                                                            optionLabel="NameOfPersonPreparingThisForm"
                                                    ...
                                                    <div class="tab">
                                                        ...
                                                        <div className='col-12'>
                                                            ...
                                                            {llcName !== null ? Object.keys(llcName).map((key, i) => {
                                                        ...
                                                        <div className='col-12'>
                                                            ...
                                                            {llc !== null ? Object.keys(llc).map((key, i) => {
                                                        ...
                                                        <div className='col-12'>
                                                            ...
                                                            {creditInfo !== null ? Object.keys(creditInfo).map((key, i) => {
            ...
            <AddCity visible={visible} setVisible={setVisible} credit={creditInfo} llc={llc} state={state} enityName={enityName} llcDetails={llcName} />
